package com.alaincieslik.springbatch.article.executionFlow.reader;
...
@Service("executionflow.sampleReader")
public class SampleReader extends BaseElement implements ItemReader<String> {
